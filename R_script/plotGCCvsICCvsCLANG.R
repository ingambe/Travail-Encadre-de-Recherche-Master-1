...
clang_0_p1_j2<-read.table(file = "intel/ia_commence/no_option/p5_j2.txt",sep="\n", header=FALSE)
clang_1_p1_j2<-read.table(file="intel/ia_commence/O1/p5_j2.txt",sep="\n", header=FALSE)
clang_2_p1_j2<-read.table(file="intel/ia_commence/O2/p5_j2.txt",sep="\n", header=FALSE)
clang_3_p1_j2<-read.table(file="intel/ia_commence/O3/p5_j2.txt",sep="\n", header=FALSE)
