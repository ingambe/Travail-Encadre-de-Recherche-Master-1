...
gcc_s_p5_j1<-read.table(file="gcc/joueur_commence/Os/resultat.txt",sep="\n", header=FALSE)
gcc_p_p5_j1<-read.table(file="gcc/joueur_commence/profile/resultat.txt",sep="\n", header=FALSE)
...
intel_s_p5_j1<-read.table(file="intel/joueur_commence/Os/resultat.txt",sep="\n", header=FALSE)
intel_p_p5_j1<-read.table(file="intel/joueur_commence/profile/resultat.txt",sep="\n", header=FALSE)
...
clang_s_p5_j1<-read.table(file="clang/joueur_commence/Os/resultat.txt",sep="\n", header=FALSE)
clang_p_p5_j1<-read.table(file="clang/joueur_commence/profile/resultat.txt",sep="\n", header=FALSE)
