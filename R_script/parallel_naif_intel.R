...
gcc5TH<-read.table(file = "intel/resultat_5.txt",sep="\n", header=FALSE)
gcc6TH<-read.table(file = "intel/resultat_6.txt",sep="\n", header=FALSE)
gcc7TH<-read.table(file = "intel/resultat_7.txt",sep="\n", header=FALSE)
gcc8TH<-read.table(file = "intel/resultat_8.txt",sep="\n", header=FALSE)
