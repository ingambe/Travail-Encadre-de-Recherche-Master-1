...
gcc<-read.table(file = "gcc/resultat_8.txt",sep="\n", header=FALSE)
clang<-read.table(file="clang/resultat_8.txt",sep="\n", header=FALSE)
intel<-read.table(file="intel/resultat_8.txt",sep="\n", header=FALSE)
