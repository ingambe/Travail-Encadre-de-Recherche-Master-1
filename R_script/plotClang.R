...
intel_0_p1_j2<-read.table(file = "clang/ia_commence/no_option/p5_j2.txt",sep="\n", header=FALSE)
intel_1_p1_j2<-read.table(file="clang/ia_commence/O1/p5_j2.txt",sep="\n", header=FALSE)
intel_2_p1_j2<-read.table(file="clang/ia_commence/O2/p5_j2.txt",sep="\n", header=FALSE)
intel_3_p1_j2<-read.table(file="clang/ia_commence/O3/p5_j2.txt",sep="\n", header=FALSE)
...
title(main = "Compartif temps d'éxécution options compilations Clang", ylab = "Temps (ms)", xlab="Options de compilation", line = NA)