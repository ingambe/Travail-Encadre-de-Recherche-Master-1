...
clang5TH<-read.table(file = "clang/resultat_5.txt",sep="\n", header=FALSE)
clang6TH<-read.table(file = "clang/resultat_6.txt",sep="\n", header=FALSE)
clang7TH<-read.table(file = "clang/resultat_7.txt",sep="\n", header=FALSE)
clang8TH<-read.table(file = "clang/resultat_8.txt",sep="\n", header=FALSE)
...
intel5TH<-read.table(file = "intel/resultat_5.txt",sep="\n", header=FALSE)
intel6TH<-read.table(file = "intel/resultat_6.txt",sep="\n", header=FALSE)
intel7TH<-read.table(file = "intel/resultat_7.txt",sep="\n", header=FALSE)
intel8TH<-read.table(file = "intel/resultat_8.txt",sep="\n", header=FALSE)
