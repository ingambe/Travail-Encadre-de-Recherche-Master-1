...
gcc<-read.table(file = "gcc/resultat_7.txt",sep="\n", header=FALSE)
clang<-read.table(file="clang/resultat_7.txt",sep="\n", header=FALSE)
intel<-read.table(file="intel/resultat_7.txt",sep="\n", header=FALSE)
