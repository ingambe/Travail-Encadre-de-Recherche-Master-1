...
wvioplot(gcc$V1, gccMap$V1, intel$V1, intelMap$V1, clang$V1, clangMap$V1, clip=TRUE, adjust = 1, names=FALSE, col=c(palette[1], palette[1], palette[2], palette[2], palette[3], palette[3]))
...
legend("topleft", generalDetails, bty = "n", cex=.5)
