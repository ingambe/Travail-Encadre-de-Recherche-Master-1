...
cat /dev/null > output/gcc/ia_commence/no_option/p1_j2.txt
cat /dev/null > output/gcc/ia_commence/O1/p1_j2.txt
cat /dev/null > output/gcc/ia_commence/O2/p1_j2.txt
cat /dev/null > output/gcc/ia_commence/O3/p1_j2.txt

cat /dev/null > output/gcc/ia_commence/no_option/p2_j2.txt
cat /dev/null > output/gcc/ia_commence/O1/p2_j2.txt
cat /dev/null > output/gcc/ia_commence/O2/p2_j2.txt
cat /dev/null > output/gcc/ia_commence/O3/p2_j2.txt

cat /dev/null > output/gcc/ia_commence/no_option/p3_j2.txt
cat /dev/null > output/gcc/ia_commence/O1/p3_j2.txt
cat /dev/null > output/gcc/ia_commence/O2/p3_j2.txt
cat /dev/null > output/gcc/ia_commence/O3/p3_j2.txt

cat /dev/null > output/gcc/ia_commence/no_option/p4_j2.txt
cat /dev/null > output/gcc/ia_commence/O1/p4_j2.txt
cat /dev/null > output/gcc/ia_commence/O2/p4_j2.txt
cat /dev/null > output/gcc/ia_commence/O3/p4_j2.txt

cat /dev/null > output/gcc/ia_commence/no_option/p5_j2.txt
cat /dev/null > output/gcc/ia_commence/O1/p5_j2.txt
cat /dev/null > output/gcc/ia_commence/O2/p5_j2.txt
cat /dev/null > output/gcc/ia_commence/O3/p5_j2.txt
...
cat /dev/null > output/gcc/joueur_commence/no_option/p1_j1.txt
cat /dev/null > output/gcc/joueur_commence/O1/p1_j1.txt
cat /dev/null > output/gcc/joueur_commence/O2/p1_j1.txt
cat /dev/null > output/gcc/joueur_commence/O3/p1_j1.txt

cat /dev/null > output/gcc/joueur_commence/no_option/p2_j1.txt
cat /dev/null > output/gcc/joueur_commence/O1/p2_j1.txt
cat /dev/null > output/gcc/joueur_commence/O2/p2_j1.txt
cat /dev/null > output/gcc/joueur_commence/O3/p2_j1.txt

cat /dev/null > output/gcc/joueur_commence/no_option/p3_j1.txt
cat /dev/null > output/gcc/joueur_commence/O1/p3_j1.txt
cat /dev/null > output/gcc/joueur_commence/O2/p3_j1.txt
cat /dev/null > output/gcc/joueur_commence/O3/p3_j1.txt

cat /dev/null > output/gcc/joueur_commence/no_option/p4_j1.txt
cat /dev/null > output/gcc/joueur_commence/O1/p4_j1.txt
cat /dev/null > output/gcc/joueur_commence/O2/p4_j1.txt
cat /dev/null > output/gcc/joueur_commence/O3/p4_j1.txt

cat /dev/null > output/gcc/joueur_commence/no_option/p5_j1.txt
cat /dev/null > output/gcc/joueur_commence/O1/p5_j1.txt
cat /dev/null > output/gcc/joueur_commence/O2/p5_j1.txt
cat /dev/null > output/gcc/joueur_commence/O3/p5_j1.txt
...
cat /dev/null > output/intel/ia_commence/no_option/p1_j2.txt
cat /dev/null > output/intel/ia_commence/O1/p1_j2.txt
cat /dev/null > output/intel/ia_commence/O2/p1_j2.txt
cat /dev/null > output/intel/ia_commence/O3/p1_j2.txt

cat /dev/null > output/intel/ia_commence/no_option/p2_j2.txt
cat /dev/null > output/intel/ia_commence/O1/p2_j2.txt
cat /dev/null > output/intel/ia_commence/O2/p2_j2.txt
cat /dev/null > output/intel/ia_commence/O3/p2_j2.txt

cat /dev/null > output/intel/ia_commence/no_option/p3_j2.txt
cat /dev/null > output/intel/ia_commence/O1/p3_j2.txt
cat /dev/null > output/intel/ia_commence/O2/p3_j2.txt
cat /dev/null > output/intel/ia_commence/O3/p3_j2.txt

cat /dev/null > output/intel/ia_commence/no_option/p4_j2.txt
cat /dev/null > output/intel/ia_commence/O1/p4_j2.txt
cat /dev/null > output/intel/ia_commence/O2/p4_j2.txt
cat /dev/null > output/intel/ia_commence/O3/p4_j2.txt

cat /dev/null > output/intel/ia_commence/no_option/p5_j2.txt
cat /dev/null > output/intel/ia_commence/O1/p5_j2.txt
cat /dev/null > output/intel/ia_commence/O2/p5_j2.txt
cat /dev/null > output/intel/ia_commence/O3/p5_j2.txt
...
cat /dev/null > output/intel/joueur_commence/no_option/p1_j1.txt
cat /dev/null > output/intel/joueur_commence/O1/p1_j1.txt
cat /dev/null > output/intel/joueur_commence/O2/p1_j1.txt
cat /dev/null > output/intel/joueur_commence/O3/p1_j1.txt

cat /dev/null > output/intel/joueur_commence/no_option/p2_j1.txt
cat /dev/null > output/intel/joueur_commence/O1/p2_j1.txt
cat /dev/null > output/intel/joueur_commence/O2/p2_j1.txt
cat /dev/null > output/intel/joueur_commence/O3/p2_j1.txt

cat /dev/null > output/intel/joueur_commence/no_option/p3_j1.txt
cat /dev/null > output/intel/joueur_commence/O1/p3_j1.txt
cat /dev/null > output/intel/joueur_commence/O2/p3_j1.txt
cat /dev/null > output/intel/joueur_commence/O3/p3_j1.txt

cat /dev/null > output/intel/joueur_commence/no_option/p4_j1.txt
cat /dev/null > output/intel/joueur_commence/O1/p4_j1.txt
cat /dev/null > output/intel/joueur_commence/O2/p4_j1.txt
cat /dev/null > output/intel/joueur_commence/O3/p4_j1.txt

cat /dev/null > output/intel/joueur_commence/no_option/p5_j1.txt
cat /dev/null > output/intel/joueur_commence/O1/p5_j1.txt
cat /dev/null > output/intel/joueur_commence/O2/p5_j1.txt
cat /dev/null > output/intel/joueur_commence/O3/p5_j1.txt
...
cat /dev/null > output/clang/ia_commence/no_option/p1_j2.txt
cat /dev/null > output/clang/ia_commence/O1/p1_j2.txt
cat /dev/null > output/clang/ia_commence/O2/p1_j2.txt
cat /dev/null > output/clang/ia_commence/O3/p1_j2.txt

cat /dev/null > output/clang/ia_commence/no_option/p2_j2.txt
cat /dev/null > output/clang/ia_commence/O1/p2_j2.txt
cat /dev/null > output/clang/ia_commence/O2/p2_j2.txt
cat /dev/null > output/clang/ia_commence/O3/p2_j2.txt

cat /dev/null > output/clang/ia_commence/no_option/p3_j2.txt
cat /dev/null > output/clang/ia_commence/O1/p3_j2.txt
cat /dev/null > output/clang/ia_commence/O2/p3_j2.txt
cat /dev/null > output/clang/ia_commence/O3/p3_j2.txt

cat /dev/null > output/clang/ia_commence/no_option/p4_j2.txt
cat /dev/null > output/clang/ia_commence/O1/p4_j2.txt
cat /dev/null > output/clang/ia_commence/O2/p4_j2.txt
cat /dev/null > output/clang/ia_commence/O3/p4_j2.txt

cat /dev/null > output/clang/ia_commence/no_option/p5_j2.txt
cat /dev/null > output/clang/ia_commence/O1/p5_j2.txt
cat /dev/null > output/clang/ia_commence/O2/p5_j2.txt
cat /dev/null > output/clang/ia_commence/O3/p5_j2.txt
...
cat /dev/null > output/clang/joueur_commence/no_option/p1_j1.txt
cat /dev/null > output/clang/joueur_commence/O1/p1_j1.txt
cat /dev/null > output/clang/joueur_commence/O2/p1_j1.txt
cat /dev/null > output/clang/joueur_commence/O3/p1_j1.txt

cat /dev/null > output/clang/joueur_commence/no_option/p2_j1.txt
cat /dev/null > output/clang/joueur_commence/O1/p2_j1.txt
cat /dev/null > output/clang/joueur_commence/O2/p2_j1.txt
cat /dev/null > output/clang/joueur_commence/O3/p2_j1.txt

cat /dev/null > output/clang/joueur_commence/no_option/p3_j1.txt
cat /dev/null > output/clang/joueur_commence/O1/p3_j1.txt
cat /dev/null > output/clang/joueur_commence/O2/p3_j1.txt
cat /dev/null > output/clang/joueur_commence/O3/p3_j1.txt

cat /dev/null > output/clang/joueur_commence/no_option/p4_j1.txt
cat /dev/null > output/clang/joueur_commence/O1/p4_j1.txt
cat /dev/null > output/clang/joueur_commence/O2/p4_j1.txt
cat /dev/null > output/clang/joueur_commence/O3/p4_j1.txt

cat /dev/null > output/clang/joueur_commence/no_option/p5_j1.txt
cat /dev/null > output/clang/joueur_commence/O1/p5_j1.txt
cat /dev/null > output/clang/joueur_commence/O2/p5_j1.txt
cat /dev/null > output/clang/joueur_commence/O3/p5_j1.txt
