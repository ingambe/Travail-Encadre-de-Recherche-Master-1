...
do
  ...
  echo "GCC \n"
  #GCC
  cat ../input/j1.txt | ./../bin/gcc_O3_parallel.out >> ../output/parallel/joue_coup/gcc/resultat_5.txt

  echo "INTEL \n"
  #INTEL
  cat ../input/j1.txt | ./../bin/intel_O3_parallel.out >> ../output/parallel/joue_coup/intel/resultat_5.txt

  echo "CLANG \n"
  #CLANG
  cat ../input/j1.txt | ./../bin/clang_O3_parallel.out >> ../output/parallel/joue_coup/clang/resultat_5.txt
done
...
do
  ...
  echo "GCC \n"
  #GCC
  cat ../input/j1.txt | ./../bin/gcc_O3_parallel.out >> ../output/parallel/joue_coup/gcc/resultat_6.txt

  echo "INTEL \n"
  #INTEL
  cat ../input/j1.txt | ./../bin/intel_O3_parallel.out >> ../output/parallel/joue_coup/intel/resultat_6.txt

  echo "CLANG \n"
  #CLANG
  cat ../input/j1.txt | ./../bin/clang_O3_parallel.out >> ../output/parallel/joue_coup/clang/resultat_6.txt
done
...
do
  ...
  echo "GCC \n"
  #GCC
  cat ../input/j1.txt | ./../bin/gcc_O3_parallel.out >> ../output/parallel/joue_coup/gcc/resultat_7.txt

  echo "INTEL \n"
  #INTEL
  cat ../input/j1.txt | ./../bin/intel_O3_parallel.out >> ../output/parallel/joue_coup/intel/resultat_7.txt

  echo "CLANG \n"
  #CLANG
  cat ../input/j1.txt | ./../bin/clang_O3_parallel.out >> ../output/parallel/joue_coup/clang/resultat_7.txt
done
...
do
  ...
  echo "GCC \n"
  #GCC
  cat ../input/j1.txt | ./../bin/gcc_O3_parallel.out >> ../output/parallel/joue_coup/gcc/resultat_8.txt

  echo "INTEL \n"
  #INTEL
  cat ../input/j1.txt | ./../bin/intel_O3_parallel.out >> ../output/parallel/joue_coup/intel/resultat_8.txt

  echo "CLANG \n"
  #CLANG
  cat ../input/j1.txt | ./../bin/clang_O3_parallel.out >> ../output/parallel/joue_coup/clang/resultat_8.txt
done
